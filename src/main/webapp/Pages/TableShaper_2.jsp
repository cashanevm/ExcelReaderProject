...
<%@page import="org.obrii.fit.mit.NevmProject.Table.Table"%>
       ...
       <div class="wrapper">
        <div class="container">
            ...
            <section class="gohome__btn">
                ...
                <form action="<%=request.getContextPath()%>/BaseTables" class="home__page-link">
                    <input type="submit" value="Назад" class="home__page-wrapper">
                </form>
            </section>
        </div>
    </div>

...
import org.obrii.fit.mit.ExcelReaderSpring.DataBase.DataStore;
...
public class FormServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
         ...
         HttpSession session = request.getSession();
                ...
                request.setAttribute("table", exel.tableFormaterSec(table,false));
               
                getServletContext().getRequestDispatcher("/Pages/TableShaper_3.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String[] values = request.getParameterValues("rows");
       // String str = request.getParameter("rows");
        //System.out.println("rows:"+ str);
       // String[] words = request.getParameter("rows");
                //str.split(",");
        
        try {
             data = new DataStore();
            data.addRow(table, values);

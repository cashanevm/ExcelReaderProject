 ...
 */
package org.obrii.fit.mit.ExcelReaderSpring.Request;
...
//        return "Body{" + "University=" + University + ", EducationalDegree=" + EducationalDegree + ", Course=" + Course + ", Semester=" + Semester + ", Faculty=" + Faculty + ", KnowledgeFieldId=" + KnowledgeFieldId + ", KnowledgeField=" + KnowledgeField + ", DirectionId=" + DirectionId + ", Direction=" + Direction + ", Program=" + Program + ", StudyForm=" + StudyForm + ", YearFrom=" + YearFrom + ", YearTo=" + YearTo + ", Director=" + Director + ", Disciplines=" + Disciplines + '}';
//    }
//    
